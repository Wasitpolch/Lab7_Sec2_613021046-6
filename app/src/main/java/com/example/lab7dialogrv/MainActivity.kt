...
import com.example.lab7dialogrv.Student
import com.example.lab7dialogrv.StudentAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    fun studentData(){
        studentList.add(Student("613021046-6","Wasitpol", 21))
        studentList.add(Student("613020247-1", "Manow", 20))
    }
